# 대회 준비
- 본 문서는 대회 직전 및 대회 중에 필요한 사항들을 서술한 문서입니다.
...
- 해설 이외 컨텐츠로써 들어갈 만한 것들도 준비하면 좋습니다.
	- 예시 1 ) 작년 대비 난이도 비교
		...
		![](./asset/during1.png){ width=50% }
		
	- 예시 2 ) 참가자의 사용 언어 통계
	
		![](./asset/during2.png){ width=50% }
		
	- 예시 3 ) LLM 모델 테스트
	
		![](./asset/during3.png){ width=50% }
