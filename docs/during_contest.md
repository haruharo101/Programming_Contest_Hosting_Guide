...
### (선택) 풍선 전달
- 난이도가 쉬운 풍선의 경우, 최대한 많이 준비해두는 것이 좋습니다.
- 풍선을 전달하는 데에 시간이 많이 소요될 수 있으므로 최대한 많은 인원이 참여하는 것이 좋습니다.
- 참가자 자리표를 현장 스태프가 알 수 있도록 해야합니다.

### (선택) 코드 프린트물 전달
- 코드 프린트물을 전달할 때에는 참가자들에게 방해되지 않는 선에서 움직여야 하며, 다른 참가자/팀에게 다른 참가자/팀의 인쇄물을 주지 않도록 유의해야합니다.
- 참가자 자리표를 현장 스태프가 알 수 있도록 해야합니다.

## (오프라인 + 온라인) 상황실 운영
- 참가자가 상황실에 입장하지 않도록 방지해야 합니다.
- 스코어보드 프리즈가 존재한다면, 스코어보드가 프리즈 되는 시점에 프리즈가 되었음을 공지해야 합니다.
- 문제와 관련된 질문이 들어온다면 최대한 빠른 시간내에 답변해야 합니다.
